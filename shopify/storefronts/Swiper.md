...
1. Shopify 开发实战：Shopify 主题 Swiper 一篇讲清楚
2. 手把手梳理 Shopify：Shopify 主题 Swiper 的关键用法和避坑点
3. 做 Shopify 项目别只会改主题，这篇带你搞懂 Shopify 主题 Swiper

## 摘要

这篇文章适合 Shopify 主题和应用开发者，围绕「Shopify 主题 Swiper」梳理核心概念、配置路径和实战注意点，方便项目中快速对照。
...
这篇围绕「Shopify 主题 Swiper」把原始笔记整理成更适合阅读和复用的版本，适合做主题开发、应用开发或者接手 Shopify 项目时快速对照。
...
你现在做 Shopify 更常遇到的是主题开发、Checkout 定制、应用接入，还是性能优化？如果你在「Shopify 主题 Swiper」上踩过坑，也可以把场景留言出来。
