...
1. Vue / React 组件传值怎么选？一篇梳理常见通信方式
2. 前端组件通信补课：Vue 和 React 的传值思路对比
3. 手把手梳理 Vue / React 组件传值：父子、兄弟和跨层通信

## 摘要

这篇文章适合正在学习组件化开发的前端同学，对比 Vue 和 React 的组件传值方式，帮你理清常见通信场景。
...
这篇围绕「Vue / React 的组件传值」把常见传值方式整理出来，方便大家对比理解。

## 知识点整理

下面进入正文。建议把父子组件、兄弟组件、跨层组件这几类场景分开看，会更容易理解。

如果你正在做组件拆分，可以先判断数据是父传子、子传父，还是需要跨层共享，再选择合适方案。
...
你平时做组件通信更喜欢 Vue 的写法还是 React 的写法？如果想看 Pinia、Redux 或 Context 的后续对比，也可以留言。
